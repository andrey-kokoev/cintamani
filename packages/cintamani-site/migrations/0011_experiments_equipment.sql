...
CREATE TRIGGER IF NOT EXISTS theoretical_model_details_no_update BEFORE UPDATE ON theoretical_model_details BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS theoretical_model_details_no_delete BEFORE DELETE ON theoretical_model_details BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS physical_material_details_no_update BEFORE UPDATE ON physical_material_details BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS physical_material_details_no_delete BEFORE DELETE ON physical_material_details BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS physical_mechanism_details_no_update BEFORE UPDATE ON physical_mechanism_details BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS physical_mechanism_details_no_delete BEFORE DELETE ON physical_mechanism_details BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS observation_interface_details_no_update BEFORE UPDATE ON observation_interface_details BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS observation_interface_details_no_delete BEFORE DELETE ON observation_interface_details BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS existing_member_assessment_details_no_update BEFORE UPDATE ON existing_member_assessment_details BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS existing_member_assessment_details_no_delete BEFORE DELETE ON existing_member_assessment_details BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS existing_member_correction_details_no_update BEFORE UPDATE ON existing_member_correction_details BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS existing_member_correction_details_no_delete BEFORE DELETE ON existing_member_correction_details BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS ontology_change_details_no_update BEFORE UPDATE ON ontology_change_details BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS ontology_change_details_no_delete BEFORE DELETE ON ontology_change_details BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS explanatory_conjecture_details_no_update BEFORE UPDATE ON explanatory_conjecture_details BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS explanatory_conjecture_details_no_delete BEFORE DELETE ON explanatory_conjecture_details BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS explanatory_conjecture_assumptions_no_update BEFORE UPDATE ON explanatory_conjecture_assumptions BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS explanatory_conjecture_assumptions_no_delete BEFORE DELETE ON explanatory_conjecture_assumptions BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS proposal_coordinate_framings_no_update BEFORE UPDATE ON proposal_coordinate_framings BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS proposal_coordinate_framings_no_delete BEFORE DELETE ON proposal_coordinate_framings BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS conjecture_relations_no_update BEFORE UPDATE ON conjecture_relations BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS conjecture_relations_no_delete BEFORE DELETE ON conjecture_relations BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS research_topic_details_no_update BEFORE UPDATE ON research_topic_details BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS research_topic_details_no_delete BEFORE DELETE ON research_topic_details BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS research_topic_loci_no_update BEFORE UPDATE ON research_topic_loci BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS research_topic_loci_no_delete BEFORE DELETE ON research_topic_loci BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS research_topic_origins_no_update BEFORE UPDATE ON research_topic_origins BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS research_topic_origins_no_delete BEFORE DELETE ON research_topic_origins BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS research_topic_relations_no_update BEFORE UPDATE ON research_topic_relations BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS research_topic_relations_no_delete BEFORE DELETE ON research_topic_relations BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS proposal_references_no_update BEFORE UPDATE ON proposal_references BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS proposal_references_no_delete BEFORE DELETE ON proposal_references BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS proposal_state_events_no_update BEFORE UPDATE ON proposal_state_events BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS proposal_state_events_no_delete BEFORE DELETE ON proposal_state_events BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS proposal_evidence_no_update BEFORE UPDATE ON proposal_evidence BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS proposal_evidence_no_delete BEFORE DELETE ON proposal_evidence BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS criticism_replies_no_update BEFORE UPDATE ON criticism_replies BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS criticism_replies_no_delete BEFORE DELETE ON criticism_replies BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS criticism_references_no_update BEFORE UPDATE ON criticism_references BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS criticism_references_no_delete BEFORE DELETE ON criticism_references BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS scoped_test_reports_no_update BEFORE UPDATE ON scoped_test_reports BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS scoped_test_reports_no_delete BEFORE DELETE ON scoped_test_reports BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS test_report_references_no_update BEFORE UPDATE ON test_report_references BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS test_report_references_no_delete BEFORE DELETE ON test_report_references BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS competing_interpretations_no_update BEFORE UPDATE ON competing_interpretations BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS competing_interpretations_no_delete BEFORE DELETE ON competing_interpretations BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS moderation_actions_no_update BEFORE UPDATE ON moderation_actions BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS moderation_actions_no_delete BEFORE DELETE ON moderation_actions BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS appeals_no_update BEFORE UPDATE ON appeals BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS appeals_no_delete BEFORE DELETE ON appeals BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS appeal_state_events_no_update BEFORE UPDATE ON appeal_state_events BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS appeal_state_events_no_delete BEFORE DELETE ON appeal_state_events BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS maintainer_exports_no_update BEFORE UPDATE ON maintainer_exports BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS maintainer_exports_no_delete BEFORE DELETE ON maintainer_exports BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS admission_links_no_update BEFORE UPDATE ON admission_links BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS admission_links_no_delete BEFORE DELETE ON admission_links BEGIN SELECT RAISE(ABORT, 'immutable public record'); END;
CREATE TRIGGER IF NOT EXISTS proposal_payment_sources_no_update BEFORE UPDATE ON proposal_payment_sources BEGIN SELECT RAISE(ABORT, 'immutable x402 proposal payment source'); END;
CREATE TRIGGER IF NOT EXISTS proposal_payment_sources_no_delete BEFORE DELETE ON proposal_payment_sources BEGIN SELECT RAISE(ABORT, 'immutable x402 proposal payment source'); END;
