-- Problem-led public conjectures. Coordinates are conjectural framings of the
-- governed registry snapshot, never admissions or epistemic assessments.
...
CREATE TABLE IF NOT EXISTS _v5_hold_proposals AS SELECT * FROM proposals;
CREATE TABLE IF NOT EXISTS _v5_hold_proposal_revisions AS SELECT * FROM proposal_revisions;
CREATE TABLE IF NOT EXISTS _v5_hold_theoretical_model_details AS SELECT * FROM theoretical_model_details;
CREATE TABLE IF NOT EXISTS _v5_hold_physical_material_details AS SELECT * FROM physical_material_details;
CREATE TABLE IF NOT EXISTS _v5_hold_physical_mechanism_details AS SELECT * FROM physical_mechanism_details;
CREATE TABLE IF NOT EXISTS _v5_hold_observation_interface_details AS SELECT * FROM observation_interface_details;
CREATE TABLE IF NOT EXISTS _v5_hold_existing_member_assessment_details AS SELECT * FROM existing_member_assessment_details;
CREATE TABLE IF NOT EXISTS _v5_hold_existing_member_correction_details AS SELECT * FROM existing_member_correction_details;
CREATE TABLE IF NOT EXISTS _v5_hold_ontology_change_details AS SELECT * FROM ontology_change_details;
CREATE TABLE IF NOT EXISTS _v5_hold_proposal_references AS SELECT * FROM proposal_references;
CREATE TABLE IF NOT EXISTS _v5_hold_proposal_evidence AS SELECT * FROM proposal_evidence;
CREATE TABLE IF NOT EXISTS _v5_hold_proposal_state_events AS SELECT * FROM proposal_state_events;
CREATE TABLE IF NOT EXISTS _v5_hold_criticisms AS SELECT * FROM criticisms;
CREATE TABLE IF NOT EXISTS _v5_hold_criticism_replies AS SELECT * FROM criticism_replies;
CREATE TABLE IF NOT EXISTS _v5_hold_criticism_references AS SELECT * FROM criticism_references;
CREATE TABLE IF NOT EXISTS _v5_hold_scoped_test_reports AS SELECT * FROM scoped_test_reports;
CREATE TABLE IF NOT EXISTS _v5_hold_test_report_references AS SELECT * FROM test_report_references;
CREATE TABLE IF NOT EXISTS _v5_hold_competing_interpretations AS SELECT * FROM competing_interpretations;
CREATE TABLE IF NOT EXISTS _v5_hold_moderation_actions AS SELECT * FROM moderation_actions;
CREATE TABLE IF NOT EXISTS _v5_hold_appeals AS SELECT * FROM appeals;
CREATE TABLE IF NOT EXISTS _v5_hold_appeal_state_events AS SELECT * FROM appeal_state_events;
CREATE TABLE IF NOT EXISTS _v5_hold_maintainer_exports AS SELECT * FROM maintainer_exports;
CREATE TABLE IF NOT EXISTS _v5_hold_admission_links AS SELECT * FROM admission_links;
CREATE TABLE IF NOT EXISTS _v5_hold_proposal_payment_sources AS SELECT * FROM proposal_payment_sources;
...
DROP TABLE IF EXISTS _v5_criticisms;
DROP TABLE IF EXISTS _v5_proposal_revisions;
DROP TABLE IF EXISTS _v5_proposals;

CREATE TABLE IF NOT EXISTS _v5_proposals (
  ...
  FOREIGN KEY (parent_proposal_id, parent_revision)
    REFERENCES _v5_proposal_revisions(proposal_id, revision)
) STRICT;

CREATE TABLE IF NOT EXISTS _v5_proposal_revisions (
  proposal_id TEXT NOT NULL REFERENCES _v5_proposals(proposal_id),
...
CREATE TABLE IF NOT EXISTS _v5_criticisms (
  ...
  focus_kind TEXT NOT NULL DEFAULT 'whole-proposal' CHECK (focus_kind IN (
    ...
    'conjecture-relation', 'other-explicit'
  )),
  focus_ref TEXT,
  UNIQUE (criticism_id, proposal_id, target_revision),
  CHECK (
    (focus_kind IN ('assumption', 'coordinate-framing', 'conjecture-relation') AND focus_ref IS NOT NULL)
    OR (focus_kind NOT IN ('assumption', 'coordinate-framing', 'conjecture-relation') AND focus_ref IS NULL)
  ),
  FOREIGN KEY (proposal_id, target_revision)
    REFERENCES _v5_proposal_revisions(proposal_id, revision)
) STRICT;

INSERT OR IGNORE INTO _v5_proposals SELECT * FROM _v5_hold_proposals;
INSERT OR IGNORE INTO _v5_proposal_revisions SELECT * FROM _v5_hold_proposal_revisions;
INSERT OR IGNORE INTO _v5_criticisms (
...
SELECT criticism_id, proposal_id, target_revision, author_account_id, title,
       criticism, scope, source_timestamp, recorded_at, 'whole-proposal', NULL
FROM _v5_hold_criticisms;
...
INSERT OR IGNORE INTO proposals SELECT * FROM _v5_hold_proposals;
INSERT OR IGNORE INTO proposal_revisions SELECT * FROM _v5_hold_proposal_revisions;
...
ALTER TABLE _v5_proposals RENAME TO proposals;
ALTER TABLE _v5_proposal_revisions RENAME TO proposal_revisions;
ALTER TABLE _v5_criticisms RENAME TO criticisms;

INSERT INTO proposal_state_events SELECT * FROM _v5_hold_proposal_state_events;
INSERT INTO theoretical_model_details SELECT * FROM _v5_hold_theoretical_model_details;
INSERT INTO physical_material_details SELECT * FROM _v5_hold_physical_material_details;
INSERT INTO physical_mechanism_details SELECT * FROM _v5_hold_physical_mechanism_details;
INSERT INTO observation_interface_details SELECT * FROM _v5_hold_observation_interface_details;
INSERT INTO existing_member_assessment_details SELECT * FROM _v5_hold_existing_member_assessment_details;
INSERT INTO existing_member_correction_details SELECT * FROM _v5_hold_existing_member_correction_details;
INSERT INTO ontology_change_details SELECT * FROM _v5_hold_ontology_change_details;
INSERT INTO proposal_references SELECT * FROM _v5_hold_proposal_references;
INSERT INTO proposal_evidence SELECT * FROM _v5_hold_proposal_evidence;
INSERT INTO criticism_replies SELECT * FROM _v5_hold_criticism_replies;
INSERT INTO criticism_references SELECT * FROM _v5_hold_criticism_references;
INSERT INTO scoped_test_reports SELECT * FROM _v5_hold_scoped_test_reports;
INSERT INTO test_report_references SELECT * FROM _v5_hold_test_report_references;
INSERT INTO competing_interpretations SELECT * FROM _v5_hold_competing_interpretations;
INSERT INTO moderation_actions SELECT * FROM _v5_hold_moderation_actions;
INSERT INTO appeals SELECT * FROM _v5_hold_appeals;
INSERT INTO appeal_state_events SELECT * FROM _v5_hold_appeal_state_events;
INSERT INTO maintainer_exports SELECT * FROM _v5_hold_maintainer_exports;
INSERT INTO admission_links SELECT * FROM _v5_hold_admission_links;
INSERT INTO proposal_payment_sources SELECT * FROM _v5_hold_proposal_payment_sources;

DROP TABLE _v5_hold_theoretical_model_details;
DROP TABLE _v5_hold_physical_material_details;
DROP TABLE _v5_hold_physical_mechanism_details;
DROP TABLE _v5_hold_observation_interface_details;
DROP TABLE _v5_hold_existing_member_assessment_details;
DROP TABLE _v5_hold_existing_member_correction_details;
DROP TABLE _v5_hold_ontology_change_details;
DROP TABLE _v5_hold_proposal_references;
DROP TABLE _v5_hold_proposal_evidence;
DROP TABLE _v5_hold_proposal_state_events;
DROP TABLE _v5_hold_proposals;
DROP TABLE _v5_hold_proposal_revisions;
DROP TABLE _v5_hold_criticisms;
DROP TABLE _v5_hold_criticism_replies;
DROP TABLE _v5_hold_criticism_references;
DROP TABLE _v5_hold_scoped_test_reports;
DROP TABLE _v5_hold_test_report_references;
DROP TABLE _v5_hold_competing_interpretations;
DROP TABLE _v5_hold_moderation_actions;
DROP TABLE _v5_hold_appeals;
DROP TABLE _v5_hold_appeal_state_events;
DROP TABLE _v5_hold_maintainer_exports;
DROP TABLE _v5_hold_admission_links;
DROP TABLE _v5_hold_proposal_payment_sources;
...
WHEN COALESCE((SELECT p.proposal_kind FROM proposal_revisions r JOIN proposals p USING(proposal_id)
               WHERE r.proposal_id=NEW.proposal_id AND r.revision=NEW.revision),'')!='explanatory-conjecture'
BEGIN SELECT RAISE(ABORT, 'coordinate framings require an explanatory conjecture revision'); END;
...
UPDATE public_schema_metadata SET metadata_value='5' WHERE metadata_key='schema_version';
